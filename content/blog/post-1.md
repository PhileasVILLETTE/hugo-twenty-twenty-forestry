...
C'est le premier site que je fait et que je met sur Internet. J'avais déjà fait plusieurs sites en HTML et en CSS lors de mon stage d'observation en 1er , mais je ne les ai jamais mis sur internet. Cependant, je ne sais pas quoi écrire donc, pour combler l'espace vide, je vais laisser cette définition du lorem ipsum en anglais ci-dessous.
